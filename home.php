...
<!-- footer secion -->
<div class = 'footer'>
<span class = 'link'> <a href = 'buying.php'> Catalogue </a></span> <span class = 'link'> <a href = 'faqs.php'>FAQ's </a></span> <span class = 'link'><a href = 'contact.php'>  Contact </a></span>
</div>
...
window.onload = function()
{
   ...
   $( ".logoimg" ).animate({
    padding:"0rem 70rem 0rem 25rem"
    }, 2000, function() {
    // Animation complete.
	$( ".effect" ).animate({
    padding:"0rem 0rem 0rem 90rem"
    }, 4000, function() {
	
    document.getElementById("headofeffect").removeChild(document.getElementById("effect"));
	$(".headtag").css("position", "static");
